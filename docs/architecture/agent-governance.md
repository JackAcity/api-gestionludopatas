...
Fase A: modelar vocabulario y JSON Schema/validador determinista. Fase B: crear 100+ casos
balanceados y medir precisión de evidencia/severidad. Fase C: permitir que un LLM traduzca
