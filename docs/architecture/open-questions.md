...
|---|---|---|---|
| OQ-001 | El repo ya es público; ¿qué capacidades adicionales de GHAS, audit/export, runner groups y del futuro target privado/enterprise están licenciadas? | No se puede extrapolar el demo público al entorno de cliente. | Owner GitHub. |
...
| OQ-008 | ¿El código, contratos, nombres de dominio e información operativa proceden de un empleador/cliente y pueden publicarse legal y contractualmente? | Puede exigir sanitizar, bifurcar o retirar este demo público. | Dueño legal/negocio. |
| OQ-009 | ¿Qué descripción, licencia, topics y aviso de referencia debe tener el repositorio público? | Define expectativas de reutilización y evita presentarlo como producción/compliance. | Dueño del repositorio. |
