...
|---|---|---|---|---|---|---|
| SRC-NIST-001 | NIST, *SP 800-218 Secure Software Development Framework* | v1.1, Final, 2022-02-03 | https://csrc.nist.gov/pubs/sp/800/218/final | Estándar/recomendación final | Vocabulario y prácticas SSDF: preparar, proteger software, producir software seguro y responder a vulnerabilidades. | No prescribe GitHub, un workflow, una herramienta ni certifica cumplimiento. |
